...
async function up(db) {
    ...
    await db.schema
        ...
        .addColumn('owner_id', 'uuid', c => c.notNull().references('users.id'))
        .addColumn('name', 'varchar(255)', c => c.notNull())
        .addColumn('value', 'decimal(12,2)', c => c.notNull().defaultTo(0))
    ...
    await db.schema
        ...
        .addColumn('base_fee', 'decimal(10,2)', c => c.notNull().defaultTo(0))
        .addColumn('overage_total', 'decimal(10,2)', c => c.notNull().defaultTo(0))
        .addColumn('total_bill', 'decimal(10,2)', c => c.notNull().defaultTo(0))
