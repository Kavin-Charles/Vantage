...
const SEED_EMAILS = [
  ...
  { id: 'em2', from: 'Priya Nair',     fromAddr: 'priya@meridianlabs.io',        subject: 'Welcome to Vencore \u2014 onboarding checklist',  preview: 'Hi Nina, here\u2019s the checklist we agreed on. I\u2019ll add the team this afternoon and run the agent install on staging.',         at: '5h',   starred: false, unread: true,  folder: 'inbox' },
  ...
  { id: 'em4', from: 'Vencore Alerts', fromAddr: 'noreply@vencore.dev',           subject: '[critical] prod-worker-01 memory 91.7%',          preview: 'Critical threshold (90%) crossed at 11:38:42 PM. Active for 3m. View alert: https://...',                                  at: '1d',   starred: false, unread: false, folder: 'inbox' },
